...
#define DRAW_SPHERE_SingleFrame(Location) \
    if (GetWorld())                       \
        DrawDebugSphere(GetWorld(), Location, 215.f, 12, FColor::Green, false, -1.f);
...
#define DRAW_POINT(Location) \
    if (GetWorld())          \
        DrawDebugPoint(GetWorld(), Location, 15.f, FColor::Cyan, true);

#define DRAW_POINT_SingleFrame(Location) \
    if (GetWorld())                      \
        DrawDebugPoint(GetWorld(), Location, 15.f, FColor::Cyan, false, -1.f);
