...
#include "Slash/Public/Characters/Bird.h"
...
void ABird::SetupPlayerInputComponent(UInputComponent *PlayerInputComponent)
{
	...
	{
		EnhancedInputComponet->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABird::Move);
		EnhancedInputComponet->BindAction(LookAction, ETriggerEvent::Triggered, this, &ABird::Look);
	}
